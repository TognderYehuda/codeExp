...
router.get("/product", async function(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
router.get("/product/:id", async function(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
router.post("/product", async function(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
router.post("/product/:id", async function(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
router.delete("/product/:id", async function(
  req: Request,
  res: Response,
  next: NextFunction
) {
